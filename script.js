      ...
      function ai(message){
          if ((username.length < 3) && (message.length>=3)){
              ...
              send_message("Nice to meet you " + username + " , How are you ? ");
                ...
                send_message("Thanks ! I am good . What would you like to know about AI ? ");
            }
                ...
                send_message("Sad to hear that . What would you like to know about AI ?");
            }
                ...
                send_message("Glad to hear that . What would you like to know about AI ? ");
            }
            ...
            else if((message.toLowerCase().indexOf("what can you tell ")>=0) && (message.toLowerCase().indexOf("AI")>=0))
            {
                send_message("I know about AI's policy reguarding the following  \
                <br> ====================================<br>\
                     |                   <span style = 'margin-left:80px;'>  AI Guidelines </span>  <br>     \
                     =====================================<br> \
                     <ul>    \
            ...
            else if((message.toLowerCase().indexOf("what")>=0) && (message.toLowerCase().indexOf("AI")==-1))
            {
                send_message("About what you want to know ?");

            }

            else if (((message.toLowerCase().indexOf("i")>=0)||(message.toLowerCase().indexOf("what")>=0))&&((message.toLowerCase().indexOf("know")>=0)&& message.toLowerCase().indexOf("AI")>=0)){
        ...
        send_message("One at a time please . Ask me about Right to post or Content ownership , not both . I can't handle that much load .")
                 ...
                 send_message("Posts by <span style='color:rgb(50, 230, 59);font-weight:bolder;'>AI </span> community members \
                 ...
                 <li> Every community member should be respectful and considerate, and assume that other people are also trying\
                  to make AI a great development resource.</li>\
                ...
                \
                 ...
                 please contact us by emailing <span style='color:rgb(50, 230, 59);font-weight:bold;'> info@ai.com.</span> </ul> ");
             }
...
;             }
                 ...
                 send_message("You can ask me Questions like  'what do you know about AI '  or  'what can you tell me about AI' etc etc  ");
             }
